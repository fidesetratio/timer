...
$(document).ready(function() {
	...
	var options = {
			...
			beforeSubmit : function(arr, $form, options){alert("before submit")},
			success : function(){
...
<div id="formcontent">
 ...
 <select class="form-control" id="availablegroupsjob">
    <option value="0" selected>Select Available Groups</option>
    <c:forEach items="${availableGroups}" var="gr">
        <option value="${gr.group_id}" ${selectedGroup == gr.group_id ? 'selected':''}>${gr.group_name}</option>
    </c:forEach>
  ...
  <div class="form-group">
    <label for="email">Type of cron Job:</label>
    <select class="form-control" id="typeofjob">
    	<option value="Y">CRON</option>
 		<option value="N">ONCE</option>
 ...
 <select class="form-control" id="availablejobcategory">
    <option value="0" selected>Select Available Job</option>
    <c:forEach items="${jobCategories}" var="jc">
        <option value="${jc.cat_id}">${jc.job_label}</option>
    </c:forEach>
  ...
  <div class="form-group">
    <label for="email">Param0:</label>
    <input type="email" class="form-control" id="email">
  </div>
  
  
  <div class="form-group">
    <label for="email">Param1:</label>
    <input type="email" class="form-control" id="email">
  </div>
